...
CREATE TABLE crash (crash_id SERIAL PRIMARY KEY, "date" TIMESTAMP, project_name TEXT, ext_device_id TEXT, project_ver TEXT, crash_dmp BYTEA,  device_id INTEGER REFERENCES device(device_id) NOT NULL);
